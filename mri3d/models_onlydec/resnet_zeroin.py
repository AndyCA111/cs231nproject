...
class Downsample3D(nn.Module):
    def __init__(self, channels, use_conv=False, use_conv1d=False,use_conv2d=True, out_channels=None, padding=1, name="conv", dim=0,):
        super().__init__()
        self.channels = channels
        self.out_channels = out_channels or channels
        self.use_conv = use_conv
...
class ResnetBlock3D(nn.Module):
    ...
    def forward(self, input_tensor, temb):
        ...
        if self.use_conv2d:
            ...
            hidden_states = self.conv11(hidden_states) + self.conv1(hidden_states) 
        ...
        if self.use_conv2d:
            ...
            hidden_states = self.conv21(hidden_states) + self.conv2(hidden_states) 
