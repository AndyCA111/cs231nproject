...
class Downsample3D(nn.Module):
    def __init__(self, channels, use_conv=False, use_conv1d=True, out_channels=None, padding=1, name="conv", dim=0,):
        super().__init__()
        self.channels = channels
        self.out_channels = out_channels or channels
        self.use_conv = use_conv
        ...
        if self.use_conv1d:
            self.convtemp = tempConv1d(self.channels, self.out_channels, 3, stride=1, padding=padding, dim=self.dim, bias=False)
...
class ResnetBlock3D(nn.Module):
    def __init__(
        ...
        *,
        ...
        #TODO: Add layer
        if use_conv1d:
            self.conv11 = tempConv1d(in_channels, out_channels, kernel_size=3, stride=1, padding=1)
